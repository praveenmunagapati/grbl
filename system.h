...
// Override bit maps. Realtime bitflags to control feed and rapid overrides.
...
#define STATE_ALARM         bit(0) // In alarm state. Locks out all g-code processes.
...
// Define control pin index for Grbl internal use.
...
extern volatile uint8_t sys_rt_exec_state;   // Global realtime executor bitflag variable for state management.
...
// Returns bitfield of control pin states, organized by CONTROL_PIN_INDEX.
